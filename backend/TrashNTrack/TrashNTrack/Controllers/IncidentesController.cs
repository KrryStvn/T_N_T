...
public class IncidentesController : ControllerBase
{
    ...
    [FromForm] string estado_incidente,
    [FromForm] DateTime fecha_resolucion,
    [FromForm] string resuelto_por
)
    {
        try
        {
            ...
            (nombre, fecha_incidente,url_foto,descripcion,id_usuario,estado_incidente,fecha_resolucion,resuelto_por)
            VALUES 
            (@nombre,GETDATE(),@url_foto,@descripcion,@id_usuario,@estado_incidente,@fecha_resolucion,@resuelto_por);
        ");
            ...
            cmd.Parameters.AddWithValue("@estado_incidente", estado_incidente);
            cmd.Parameters.AddWithValue("@fecha_resolucion", fecha_resolucion);
            cmd.Parameters.AddWithValue("@resuelto_por", resuelto_por);
